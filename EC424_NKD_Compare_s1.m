...
%         - Sensitivity 1: Baseline with communication -
%
%===============================================================
...
dynare EC424_NKD_baseline.mod -DECONW=0.8 -DCOMMW=0.7
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKD_baseline.mod -DREACTW=0.8 -DCOMMW=0.7
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKD_baseline.mod -DECONW=0.8 -DREACTW=0.8 -DCOMMW=0.7
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKD_baseline.mod -DEXPW=0.8 -DECONW=0.8 -DREACTW=0.8 -DCOMMW=0.7
