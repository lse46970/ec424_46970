...
dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=0.8 -DREACTW=1
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=1 -DREACTW=0.8
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.8 -DECONW=1 -DREACTW=1
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.8 -DECONW=0.8 -DREACTW=0.8
