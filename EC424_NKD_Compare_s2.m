...
%      - Sensitivity 2: Developing wihout communication -
%
%===============================================================
...
dynare EC424_NKD_developing.mod -DECONW=0.7
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKD_developing.mod -DREACTW=0.7
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKD_developing.mod -DECONW=0.7 -DREACTW=0.7
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKD_developing.mod -DEXPW=0.7 -DECONW=0.7 -DREACTW=0.7
