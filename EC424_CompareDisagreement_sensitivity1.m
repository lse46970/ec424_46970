%%% everything same as in baseline, with only changing rho of shocks from
%%% 0.9 to 0.5

clear all; close all; clc;

dynare EC424_NKmodel_disagreement_sensitivity1.mod 
irfs_agreed = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity1.mod -DEXPW=1 -DECONW=0.8 -DREACTW=1
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity1.mod -DEXPW=1 -DECONW=1 -DREACTW=0.8
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity1.mod -DEXPW=0.8 -DECONW=1 -DREACTW=1
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity1.mod -DEXPW=0.8 -DECONW=0.8 -DREACTW=0.8
...
savefig(fig, 'ec424_sensitivity1.fig');

print(fig, 'ec424_sensitivity1', '-djpeg', '-r300'); % '-r300' sets the resolution to 300 DPI