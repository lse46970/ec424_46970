...
dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=0.9 -DREACTW=1
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=1 -DREACTW=0.9
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.9 -DECONW=1 -DREACTW=1
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.9 -DECONW=0.9 -DREACTW=0.9
...
hL = legend({'Agreed' 'Disagreed (econ=0.9)' 'Disagreed (react=0.9)' 'Disagreed (exp=0.9)' 'Disagreed (all=0.9)'}, 'Orientation', 'horizontal', 'Location', 'southoutside');
...
savefig(fig, 'ec424_appendix1.fig');

print(fig, 'ec424_appendix1', '-djpeg', '-r300'); % '-r300' sets the resolution to 300 DPI