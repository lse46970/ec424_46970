%%% Appendix - enhancing disagreement from 0.8 to 0.7

%%% Appendix - lowering disagreement from 0.8 to 0.9

clear all; close all; clc;

dynare EC424_NKmodel_disagreement_baseline.mod
irfs_agreed = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=0.7 -DREACTW=1
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=1 -DREACTW=0.7
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.7 -DECONW=1 -DREACTW=1
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.7 -DECONW=0.7 -DREACTW=0.7
...
hL = legend({'Agreed' 'Disagreed (econ=0.7)' 'Disagreed (react=0.7)' 'Disagreed (exp=0.7)' 'Disagreed (all=0.7)'}, 'Orientation', 'horizontal', 'Location', 'southoutside');
...
savefig(fig, 'ec424_appendix2.fig');

print(fig, 'ec424_appendix2', '-djpeg', '-r300'); % '-r300' sets the resolution to 300 DPI