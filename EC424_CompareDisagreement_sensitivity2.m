%%% Everything the same as in baseline, only phi_y = 0 instead of 0.5/4;

clear all; close all; clc;

dynare EC424_NKmodel_disagreement_sensitivity2.mod
irfs_agreed = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity2.mod -DEXPW=1 -DECONW=0.8 -DREACTW=1
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity2.mod -DEXPW=1 -DECONW=1 -DREACTW=0.8
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity2.mod -DEXPW=0.8 -DECONW=1 -DREACTW=1
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKmodel_disagreement_sensitivity2.mod -DEXPW=0.8 -DECONW=0.8 -DREACTW=0.8
...
savefig(fig, 'ec424_sensitivity2.fig');

print(fig, 'ec424_sensitivity2', '-djpeg', '-r300'); % '-r300' sets the resolution to 300 DPI