%%% This is varying levels of disagreement along different dimensions
...
dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=0.8 -DREACTW=0.8
irfs_disagreed_econ = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=0.8 -DREACTW=0.2
irfs_disagreed_react = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=1 -DECONW=0.2 -DREACTW=0.8
irfs_disagreed_exp = oo_.irfs;

dynare EC424_NKmodel_disagreement_baseline.mod -DEXPW=0.2 -DECONW=0.8 -DREACTW=0.8
...
hL = legend({['Agreed'] ['(exp=1; econ=react=0.8)'] ['(exp=1; econ=0.8; react=0.2)'] ['(exp=1; econ=0.2; react=0.8)'] ['(exp=0.2; econ=react=0.8)']}, 'Orientation', 'horizontal', 'Location', 'southoutside');
...
savefig(fig, 'ec424_appendix3.fig');

print(fig, 'ec424_appendix3', '-djpeg', '-r300'); % '-r300' sets the resolution to 300 DPI
